      ...
      <div className="max-w-md w-full space-y-6 relative z-10">
        ...
        <div className="bg-ivory border border-sandalwood/15 rounded-sm p-8 shadow-sm">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="name" className="block text-sm font-light text-deep-brown mb-2" style={{ fontFamily: language === 'hi' ? 'Noto Serif Devanagari, serif' : 'inherit' }}>
                {t('auth.fullName')}
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-light text-deep-brown mb-2" style={{ fontFamily: language === 'hi' ? 'Noto Serif Devanagari, serif' : 'inherit' }}>
