...
const size = 24; // h-6
const boxClassName =
  "absolute h-6 w-6 rounded-md bg-transparent p-px border border-amber-100 border-box group ";
      ...
      return (
        ...
        >
          <div
            ...
            className={cn(
              "h-full w-full scale-90 rounded bg-primary opacity-0 transition-all duration-700",
              {
...
export default function InteractiveGrid({
  ...
  return (
    <div
      className={cn("storybook-fix relative h-full w-full overflow-hidden  bg-primary", className)}
    //   style={{
    //     backgroundImage:
